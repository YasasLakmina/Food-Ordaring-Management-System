          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex flex-1 max-w-md mx-4">
              <div className="relative w-full">
                <input
                  ...
                  className="w-full py-2 pl-10 pr-4 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-900"
                />
                <SearchIcon
                  size={18}
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <button
                ...
                className="flex items-center space-x-1 text-gray-600 cursor-pointer hover:text-gray-900 transition-colors"
              >
                <UserIcon size={24} />
