...
import { StarIcon, ClockIcon, DollarSignIcon, InfoIcon, ChevronDownIcon } from 'lucide-react';
...
const restaurants = {
  ...
  '2': {
    ...
    description: 'Authentic Italian pizzas made with our secret family recipe. Wood-fired oven and premium ingredients.'
  },
  '3': {
    id: '3',
    name: 'Sushi Express',
    ...
    description: 'Fresh sushi and sashimi prepared by master chefs. We use only the freshest fish delivered daily.'
  },
  '4': {
    id: '4',
    name: 'Taco Fiesta',
    ...
    description: 'Authentic Mexican street food with a modern twist. Our salsas are made fresh daily.'
  },
  '5': {
    id: '5',
    name: 'Pasta Paradise',
    ...
    description: 'Homemade pasta and authentic Italian sauces. Every dish is prepared with love and tradition.'
  },
  '6': {
    id: '6',
    name: 'Salad & Co',
    ...
    description: 'Fresh, healthy salads and wraps made with locally-sourced organic ingredients.'
  }
};
// Mock menu data
const menuItems = {
  '1': [{
    ...
    price: 4.99,
    imageUrl: 'https://images.unsplash.com/photo-1639024471283-03518883512d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80',
    category: 'Sides'
  }, {
    id: '106',
    ...
    price: 5.99,
    imageUrl: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80',
    category: 'Drinks'
  }],
  '2': [{
    id: '201',
    ...
    price: 14.99,
    imageUrl: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80',
    category: 'Pizzas'
  }],
  '3': [{
    id: '301',
    ...
    price: 6.99,
    imageUrl: 'https://images.unsplash.com/photo-1534482421-64566f976cfa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80',
    category: 'Nigiri'
  }],
  '4': [{
    id: '401',
    name: 'Beef Tacos',
    description: 'Three corn tortillas filled with seasoned beef, lettuce, cheese, and salsa.',
    price: 9.99,
    ...
    price: 10.99,
    imageUrl: 'https://images.unsplash.com/photo-1552332386-f8dd00dc2f85?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80',
    category: 'Burritos'
  }],
  '5': [{
    id: '501',
    ...
    price: 13.99,
    imageUrl: 'https://images.unsplash.com/photo-1612874742237-6526221588e3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80',
    category: 'Pasta'
  }, {
    id: '502',
    ...
    price: 12.99,
    imageUrl: 'https://images.unsplash.com/photo-1645112411341-6c4fd023882a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80',
    category: 'Pasta'
  }],
  '6': [{
    id: '601',
    ...
    price: 8.99,
    imageUrl: 'https://images.unsplash.com/photo-1546793665-c74683f339c1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80',
    category: 'Salads'
  }, {
    id: '602',
    name: 'Chicken Wrap',
    description: 'Grilled chicken, mixed greens, and avocado in a whole wheat wrap.',
    price: 9.99,
    imageUrl: 'https://images.unsplash.com/photo-1626700051175-6818013e1d4f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80',
    category: 'Wraps'
  }]
};
const RestaurantDetail: React.FC = () => {
  ...
  const restaurantItemsInCart = cartItems.filter(item => item.restaurantId === id);
  const itemCount = restaurantItemsInCart.reduce((total, item) => total + item.quantity, 0);
  if (!restaurant) {
  ...
  return <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
          <div className="flex items-start">
            <InfoIcon size={20} className="text-gray-500 mt-1 mr-2 flex-shrink-0" />
            <div>
        ...
        <div className="bg-white sticky top-16 z-10 shadow-sm mb-6">
          <div className="container mx-auto px-4">
            <div className="flex space-x-6 overflow-x-auto py-3">
              {categories.map(category => <button key={category} onClick={() => setActiveCategory(category)} className={`whitespace-nowrap px-1 py-2 border-b-2 text-sm font-medium ${activeCategory === category ? 'border-green-600 text-green-600' : 'border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300'}`}>
                  {category}
                </button>)}
            </div>
          </div>
        ...
        <div className="mb-20">
          ...
          <div className="space-y-6">
            {filteredMenu.map(item => <FoodCard key={item.id} id={item.id} name={item.name} description={item.description} price={item.price} imageUrl={item.imageUrl} restaurantId={restaurant.id} restaurantName={restaurant.name} />)}
          </div>
          {filteredMenu.length === 0 && <div className="text-center py-10">
      ...
      {itemCount > 0 && <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-200 p-4">
          <div className="container mx-auto">
            <div className="flex items-center justify-between">
              ...
              <Link to="/checkout" className="bg-green-600 hover:bg-green-700 text-white py-2 px-6 rounded-full flex items-center transition-colors duration-300">
                <span>Checkout</span>
